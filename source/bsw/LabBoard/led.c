...
RC_t PWM_LED_Set(uint8_t red, uint8_t yellow, uint8_t green) {

    PWM_Red_WriteCompare(LED__Pulse_Width[red]);
    PWM_Yellow_WriteCompare(LED__Pulse_Width[yellow]);
    PWM_Green_WriteCompare(LED__Pulse_Width[green]);
